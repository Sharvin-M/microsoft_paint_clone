...
public:
  ColorPicker() {
    ...
    rPlusButton =
        Rectangle(-0.5f, -0.925f, 0.1f, 0.05f, Color(0.9f, 0.2f, 0.2f));
    gPlusButton =
        Rectangle(-0.3f, -0.925f, 0.1f, 0.05f, Color(0.2f, 0.9f, 0.2f));
    bPlusButton =
        Rectangle(-0.1f, -0.925f, 0.1f, 0.05f, Color(0.2f, 0.2f, 0.9f));

    rMinusButton =
        Rectangle(-0.5f, -0.825f, 0.1f, 0.05f, Color(0.7f, 0.1f, 0.1f));
    gMinusButton =
        Rectangle(-0.3f, -0.825f, 0.1f, 0.05f, Color(0.1f, 0.7f, 0.1f));
    bMinusButton =
        Rectangle(-0.1f, -0.825f, 0.1f, 0.05f, Color(0.1f, 0.1f, 0.7f));
  ...
  bool contains(float x, float y) {
    return area.contains(x, y) || rPlusButton.contains(x, y) ||
           gPlusButton.contains(x, y) || bPlusButton.contains(x, y) ||
           rMinusButton.contains(x, y) || gMinusButton.contains(x, y) ||
